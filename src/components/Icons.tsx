...
export function IconUpload({ size = 22, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconLogin({ size = 18, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconUserPlus({ size = 18, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
